...
import (
	...
	faasv1alpha1 "github.com/stefanprodan/faas-k8s/pkg/apis/o6sio/v1alpha1"
	clientset "github.com/stefanprodan/faas-k8s/pkg/client/clientset/versioned"
	faasscheme "github.com/stefanprodan/faas-k8s/pkg/client/clientset/versioned/scheme"
	informers "github.com/stefanprodan/faas-k8s/pkg/client/informers/externalversions"
	listers "github.com/stefanprodan/faas-k8s/pkg/client/listers/o6s/v1alpha1"
)
